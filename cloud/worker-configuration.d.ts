/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 922cbdab0a6e2549aa460528be314ddb)
// Runtime types generated with workerd@1.20260831.1 2026-09-02 nodejs_compat
interface __BaseEnv_Env {
	RVW_ENV: "spike" | "prod" | "dev";
	RVW_VERSION: "0.0.0";
	CODEX_PROXY_HOST: "codex.nekos.me";
	RVW_SANDBOX: DurableObjectNamespace<import("./worker/src/index").RvwSandbox>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./worker/src/index");
		durableNamespaces: "RvwSandbox";
	}
	interface SpikeEnv {
		RVW_ENV: "spike";
		RVW_VERSION: "0.0.0";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "RVW_ENV" | "RVW_VERSION" | "CODEX_PROXY_HOST">> {}
}
